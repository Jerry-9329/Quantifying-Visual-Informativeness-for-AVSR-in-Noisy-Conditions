...
Pearson = [-0.193, -0.093, -0.017, 0.019, 0.140, 0.096, 0.056]
...
plt.title('Lip Speakers')
plt.xlabel('SNR (dB)')
plt.ylabel('Pearson Correlation')

output_path = "/Users/Study/Speech_Recognition/Final_Thesis/Fig/Chapter5/raster/Lip_Pearson.png"
