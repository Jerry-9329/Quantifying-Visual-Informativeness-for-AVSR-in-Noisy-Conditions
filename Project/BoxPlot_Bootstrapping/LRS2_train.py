...
def plot_faceted_bootstrap_boxplot(combined_df):
    title_map = {
        "IWER_MaFI_6_15.csv": "SNR 15dB (Audio-Visual)",
        "IWER_MaFI_6_0.csv": "SNR 0dB (Audio-Visual)",
        "IWER_MaFI_6_-15.csv": "SNR -15dB (Audio-Visual)",
        "IWER_MaFI_6_v.csv": "Visual-only"
    }
    ...
    output_path = "/Users/Study/Speech_Recognition/Final_Thesis/Fig/Chapter4/raster/IWER_LRS2_Training.png"
...
if __name__ == "__main__":
    csv_files = [
        "/Users/Study/avHubert/LRS2_train/large_av_433_15/IWER_MaFI_6_15.csv",
        "/Users/Study/avHubert/LRS2_train/large_av_433_0/IWER_MaFI_6_0.csv",
        "/Users/Study/avHubert/LRS2_train/large_av_433_-15/IWER_MaFI_6_-15.csv",
        "/Users/Study/avHubert/LRS2_train/large_v_433/IWER_MaFI_6_v.csv",
    ]
    ...
    for path in csv_files:
        df = pd.read_csv(path)
        boot_df = bootstrap_mafi_iwer(df, n_iterations=500, sample_size=300)
