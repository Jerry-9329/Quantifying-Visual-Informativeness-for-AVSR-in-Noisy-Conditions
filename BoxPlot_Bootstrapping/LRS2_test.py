...
def plot_faceted_bootstrap_boxplot(combined_df):
    title_map = {
        "IWER_6_MaFI_15_resample.csv": "SNR 15dB (Audio-Visual)",
        "IWER_6_MaFI_0_resample.csv": "SNR 0dB (Audio-Visual)",
        "IWER_6_MaFI_-15_resample.csv": "SNR -15dB (Audio-Visual)",
        "IWER_6_MaFI_resample.csv": "Visual Mode",
    }
    ...
    g.fig.suptitle("LRS2 Test Set", fontsize=16)
    ...
    for ax in g.axes.flatten():
        ...
        medians = source_df.groupby("MaFI Group")["IWER"].median()
        print(f"\n>>> Median IWERs for: {custom_title}")
        for group, median in medians.items():
            print(f"  {group}: {median:.4f} ({median:.2%})")
    ...
    # output_path = "/Users/Study/Speech_Recognition/Final_Thesis/Fig/Chapter4/raster/LRS2_Test_Box.png"
...
if __name__ == "__main__":
    csv_files = [
        "/Users/Study/avHubert/LRS2/large_av_433_15/IWER_6_MaFI_15_resample.csv",
        "/Users/Study/avHubert/LRS2/large_av_433_0/IWER_6_MaFI_0_resample.csv",
        "/Users/Study/avHubert/LRS2/large_av_433_-15/IWER_6_MaFI_-15_resample.csv",
        "/Users/Study/avHubert/LRS2/large_v_433/IWER_6_MaFI_resample.csv"
    ]
