...
def plot_faceted_bootstrap_boxplot(combined_df):
    title_map = {
        ...
        "IWER_MaFI_6_resample_-10.csv": "SNR -10dB (Audio-Visual)",
        "IWER_MaFI_6_resample_-5.csv": "SNR -5dB (Audio-Visual)",
        "IWER_MaFI_6_resample_0.csv": "SNR 0dB (Audio-Visual)",
        "IWER_MaFI_6_resample_5.csv": "SNR 5dB (Audio-Visual)",
        "IWER_MaFI_6_resample_10.csv": "SNR 10dB (Audio-Visual)",
        "IWER_MaFI_6_resample_15.csv": "SNR 15dB (Audio-Visual)",
        "IWER_MaFI_6_resample_v.csv": "Visual-Only",
    }
    ...
    g.fig.suptitle("Lip Speakers", fontsize=16)
    ...
    for ax in g.axes.flatten():
        ...
        if "SNR -10dB" in custom_title or "SNR -5dB" in custom_title or "SNR -15dB" in custom_title:
            ax.set_ylim(0.3, 1)
        else:
            ax.set_ylim(0, 0.6)
    ...
    output_path = "/Users/Study/Speech_Recognition/Final_Thesis/Fig/Chapter5/raster/Lip_Box.png"
    g.savefig(output_path, dpi=250, bbox_inches='tight')
...
if __name__ == "__main__":
    csv_files = [
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/Visual/IWER_MaFI_6_resample_v.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/-15/IWER_MaFI_6_resample_-15.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/-10/IWER_MaFI_6_resample_-10.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/-5/IWER_MaFI_6_resample_-5.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/0/IWER_MaFI_6_resample_0.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/5/IWER_MaFI_6_resample_5.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/10/IWER_MaFI_6_resample_10.csv",
        "/Users/Study/avHubert/Resample_40/TCD-TIMIT/Lip/15/IWER_MaFI_6_resample_15.csv",
    ]
